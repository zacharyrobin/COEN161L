...
(function(){
	...
	Snake.prototype.isFoodEaten = function () {
		console.log(parseInt(this.snakeParts[0].compStyle.top) == parseInt(food.compStyle.top));
		if((parseInt(this.snakeParts[0].compStyle.top) == parseInt(food.compStyle.top)) && (parseInt(this.snakeParts[0].compStyle.left) == parseInt(food.compStyle.left))){
			return true;
		}
		return 	false;
	};
